...
def run_training():
    ...
    out_dir  = '/home/ck/project/results/xception-180-01b' # s_xx1'
    initial_checkpoint = \
        '/home/ck/project/results/xception-180-01b/checkpoint/00155000_model.pth'
        #None  #


    pretrained_file = \
        '/home/ck/project/pretrained/xception.keras.convert.pth'
